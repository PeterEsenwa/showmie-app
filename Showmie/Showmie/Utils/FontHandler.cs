namespace Showmie.Utils
{
    class FontHandler
    {
        ...
        {
            int oldMenuRowHeight = (int)Xamarin.Forms.Application.Current.Resources["MenuRowHeight"];
            ...
            Xamarin.Forms.Application.Current.Resources["MenuRowHeight"] = (int)(oldMenuRowHeight * difference);
