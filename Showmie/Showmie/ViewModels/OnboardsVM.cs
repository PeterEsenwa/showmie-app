...
namespace Showmie
{
    ...
    {
        public SingleBoard thirdBoard = new SingleBoard("light_bulb.png", "View the works of many other professionals from around the continient and get inspired", "Get Inspired to Create");
